...
//       TX 10kHz tone burst for 1s   (deterministically time-stamped)
//       1s silence:
...
//           - hold the line until exactly 1s of silence has elapsed,
...
public:
    ...
    static constexpr double kSilenceDurationS = 1.0;
