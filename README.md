...
2.4 / 5.1 / 5.8 GHz, transmitting a 10 kHz baseband tone for 1 second at
each band, followed by 1 second of silence during which it retunes both
...
- **Timing**: burst cadence is anchored to the USRP's own clock
  ...
  `BurstController::control_loop()`. This is what keeps the 1s/1s cadence
